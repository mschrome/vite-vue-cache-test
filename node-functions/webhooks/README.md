...
本项目提供了两个版本的 webhook 处理函数：

### 1️⃣ Demo 版（推荐新手）- `demo.js`

**API 端点**: `/webhooks/demo`

- ✅ **仅 100 行代码**，简洁易懂
- ✅ 适合快速学习和开发
- ✅ 清晰的代码结构
- ✅ 容易复制和修改
- 📖 **文档**: [DEMO-GUIDE.md](./DEMO-GUIDE.md)

### 2️⃣ 完整版（本文档）- `edgeone.js`

**API 端点**: `/webhooks/edgeone`

- ✅ **330 行代码**，功能完整
- ✅ 详细的调试日志
- ✅ 完整的错误堆栈
- ✅ 适合生产环境
- 📖 **对比文档**: [VERSION-COMPARISON.md](./VERSION-COMPARISON.md)
...
**当前完整版已优化用于调试：**
- ✅ **详细日志输出**：记录所有请求细节
- ✅ **Token 验证已放宽**：即使验证失败也会继续处理（仅警告）
- ✅ **支持 GET 请求**：用于健康检查
- ✅ **宽松的错误处理**：即使缺少字段也会尝试处理
- ✅ **完整的调试信息**：响应中包含 debug 字段

**如果你是新手或想快速开始，建议先看 [Demo 版](./DEMO-GUIDE.md)！**
